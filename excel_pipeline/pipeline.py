...
The main processing flow is defined here as ordinary Python functions
that call skill functions in a fixed sequence. Keep the function
signatures aligned with the two Streamlit pages so the UI can invoke
them directly.
"""
